...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>แ้ไชเพิ่มข้อมูลส่วนแถบน้ำเงิน</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" action="edit_tab.php" enctype="multipart/form-data">
                    <input type="text" id="id" name="id" value="<?php echo $row["teacher_id"]; ?>" hidden>

                    <div class="card-body">
                        <div class="form-group">
                            <label for="teacher_name"><span class="text-danger">*</span> ชื่อ - นามสกุล
                                (หัวหน้าสาขาวิชาระบบสารสนเทศ)</label>
                        ...
                        <div class="form-group">
                            <label for="image_name"><span class="text-danger">*</span> รูปภาพข่าว</label>
                            <div class="img">
                                <img src="../image/tab/<?php echo $row["image_name"];?>" class="img"
                                    style="width: 150px;">
                            </div>
                            <br>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description"
                                placeholder="กรุณารายละเอียด"><?php echo $row["description"]; ?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            value="<?php echo $row["youtube_link"]; ?>"  placeholder="(กรุณาใส่ Link Youtube)" require>
                        </div>
                    </div>
                    <!-- /.card-body -->
