                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header"
                            ...
                            <h3 class="card-title" style="color: #ffffff;">จัดการข้อมูลบุคลากร</h3>

                        </div>

                        <div class="card-body">

                            <a class="btn btn-md btn-success" href="frm_add_user.php"><i class="fa fa-plus-square"></i>
                                เพิ่มข้อมูล</a>
...
$sql = "SELECT a.*, b.lavel_name 
        ...
        WHERE a.is_approved = 1"; // เลือกเฉพาะผู้ที่ได้รับการอนุมัติให้เข้าใช้งาน
...
?>
                                    <tr>
                                        ...
                                        <td><?php echo $rows["personal_tel"]; ?></td>
        ...
        if ($status == '1') {
            ...
            echo '<span style="color: green;">นักศึกษา</span>';
        } elseif ($status == '4') {
            echo '<span style="color: green;">บุคคลทั่วไป</span>';
        } elseif ($status == '5') {
            echo '<span style="color: red;">ครูอาจารย์</span>';
        }
        ?>
                                        </td>
                                        <!-- <td class="text-bold">
        ...
        ?> -->
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-warning"
                                                href="frm_edit_user.php?personal_id=<?php echo $rows["personal_id"]; ?>">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a class="btn btn-sm btn-danger"
                                                href="delete_user.php?personal_id=<?php echo $rows["personal_id"]; ?>"
                                                onclick="return confirm('คุณแน่ใจต้องการลบข้อมูลผู้รอนนุมัติ?')">
