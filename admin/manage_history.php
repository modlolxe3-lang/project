                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header"
                            ...
                            <h3 class="card-title" style="color: #ffffff;">จัดการข้อมูลประวัติสาขา</h3>

                        </div>

                        <div class="card-body">

                            <a class="btn btn-md btn-success" href="frm_add_history.php"><i
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><small><?php echo $rows["history_detail"]; ?></small></td>
                                        <td>
                                            <a class="btn btn-sm btn-warning"
                                                href="frm_edit_history.php?id=<?php echo $rows["id"]; ?>"><i
