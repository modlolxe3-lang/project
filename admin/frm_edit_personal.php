    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" action="edit_personal.php" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="img">
                                <img src="../image/personal/<?php echo $row["personal_img"];?>" class="img"
                                    style="width: 150px;">
                            </div>
                            <br>
                            <input type="file" class="form-control" id="personal_img" name="personal_img"
                                placeholder="รูปภาพอาจารย์" accept="image/*" >
                        </div>
                        <div class="form-group">
                            ...
                            <input type="varchar" class="form-control" id="bachelor_degree" name="bachelor_degree"
                                value="<?php echo $row["bachelor_degree"];?>" placeholder="กรุณาระดับการศึกษาปริญญาตรี"
                                require>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="varchar" class="form-control" id="master_degree" name="master_degree"
                                value="<?php echo $row["master_degree"];?>" placeholder="กรุณาระดับการศึกษาปริญญาโท"
                                require>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="varchar" class="form-control" id="doctorate_degree" name="doctorate_degree"
                                value="<?php echo $row["doctorate_degree"];?>" placeholder="กรุณาระดับการศึกษาปริญญาเอก"
                                require>
                        </div>
                        <div class="form-group">
