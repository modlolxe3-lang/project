                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-md btn-success" href="frm_add_personal.php"><i class="fa fa-plus-square"></i>
                                เพิ่มข้อมูล</a>
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../image/personal/<?php echo $rows["personal_img"]; ?>" target="_black">
                                            <img src="../image/personal/<?php echo $rows["personal_img"]; ?>" class="img" style="width: 80px;">
                                        ...
                                        <td>
                                            <a class="btn btn-xs btn-warning"
                                                ...
                                                href="delete_personal.php?personal_id=<?php echo $rows["personal_id"]; ?>"    
                                                onclick="return confirm('คุณแน่ใจต้องการลบข้อมูลอาจารย์ท่านนี้?')"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
